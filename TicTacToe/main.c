...
int main(void)
{
    ...
    uint32_t turn;              // keeps track of who's turn it is. Starts with player 1
    ...
    do{
        ...
        switch (menu){
            ...
            case 2:
                ...
                turn = 1;                                               //always start with player one
                while (1){
                    if (turn == 1) printf("\nIt is Player 1's turn."); //display whose turn is it
                    ...
                    if (turn == 1){
                        ...
                        comp = rand() % ((input * input) + 1);          //generate a random number between 1 and the square of the board size
                        while (UpdateBoard(comp, turn) == -1){          //enter Generated number as move
                            comp = rand() % ((input * input) + 1);      //generate a new number is the previous number was already entered
                        }
